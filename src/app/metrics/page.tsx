...
const MetricsForm = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center mx-auto pt-8 pb-8">
      <h1 className="text-4xl font-bold mb-4">📏 MEDIDAS 📐</h1>
          ...
          >
            <Form className='p-10 mt-10'>
              ...
              <div className='text-center'>
                <button value="button" className='btn btn-danger btn-lg' onClick={() => router.push('/users')}>Voltar</button>
                <button value="Submit" className='btn btn-success btn-lg ml-4'>Enviar</button>
              </div>
            </Form>
          </Formik>
        </div>
